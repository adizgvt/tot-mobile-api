    ...
    <div class="card col-md-8">
        <div class="card-body">
            <div class="col-auto col-md-12">
                ...
                <form action="<?php echo e(route('form-submit')); ?>" method="POST" class="row g-3">
                    <?php echo csrf_field(); ?>
                    <div class="col-md-6">
...
<?php echo $__env->make('layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/pocketdata/Desktop/blog-training/resources/views/create.blade.php ENDPATH**/ ?>